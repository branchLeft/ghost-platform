 ...
 * calls (doc 13 §1.3/§2.4), plus an unauthenticated health check. Deliberately
 * no global body-parser: the messages route reads the multipart body itself
 * via busboy, and adding express.json()/urlencoded() ahead of it would
 * consume the request stream before busboy sees it.
 *
